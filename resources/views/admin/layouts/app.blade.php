    ...
    <ul class="nav">
        ...
        <li class="nav-item">
          <a class="nav-link p-0" aria-current="page" href="#">
            <img src="{{ asset('images/'.auth()->user()->photo) }}" width="35px" height="35px" class="rounded-circle">
          </a>
        </li>
        @endauth
    ...
    <div class="col-md-3 side"  >
      ...
      <li class="list-group-item  py-3 rounded bg-white border mt-2 mb-5" style="font-size: 18px;">
        <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button class="dropdown-item text-secondary text-dark fw-bold"><i class="fa-solid fa-gauge ms-4 me-2"></i>Logout</button>
        </form>
      </li>
